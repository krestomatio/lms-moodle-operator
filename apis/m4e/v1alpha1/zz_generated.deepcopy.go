...
func (in *M4eSpec) DeepCopyInto(out *M4eSpec) {
	*out = *in
	...
	in.NotifyStatus.DeepCopyInto(&out.NotifyStatus)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NotifyStatus) DeepCopyInto(out *NotifyStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NotifyStatus.
func (in *NotifyStatus) DeepCopy() *NotifyStatus {
	if in == nil {
		return nil
	}
	out := new(NotifyStatus)
	in.DeepCopyInto(out)
	return out
}
